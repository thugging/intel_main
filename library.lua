...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("IntelSettings.json") then
			writefile("IntelSettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("IntelSettings.json"))
	...
	options = self:set_defaults({
		...
		Link = "https://discord.gg/intel"
	}, options)
	
	if getgenv and getgenv().IntelUI then
		getgenv():IntelUI()
		getgenv().IntelUI = nil
	end
	...
	creditsTab:credit{Name = "Abstract", Description = "Developer of the GUI", Discord = "Abstract#8007", V3rmillion = "AbstractPoo"}
	creditsTab:credit{Name = "Deity", Description = "Developer of the GUI", Discord = "Deity#0228", V3rmillion = "0xDEITY"}
