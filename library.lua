...
Hello, please credit if you use this edited version.
...
function WindowTable:Window(Htitle,GMtitle,toclose)
	...
	LeftFrameLine.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
	...
	MainFrameGlow.BackgroundColor3 = Color3.fromRGB(21, 21, 21)
	...
	MainFrameGlow1.ImageColor3 = Color3.fromRGB(21, 21, 21)
	...
	MainFrameGlow2.ImageColor3 = Color3.fromRGB(21, 21, 21)
	...
	LeftFrame.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
	...
	function Tabs:Tab(tabname)
		...
		TabBtnGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(27, 27, 27)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(19, 101, 190))}
		...
		function ElementHandler:Toggle(togInfo, callback)
			...
			ToggleBox.BackgroundColor3 = Color3.fromRGB(74, 74, 74)
		...
		function ElementHandler:Slider(text,min,max,start,callback)
			...
			SlideFrame.BackgroundColor3 = Color3.fromRGB(74, 74, 74)
			...
			Value.BackgroundColor3 = Color3.fromRGB(74, 74, 74)
		...
		function ElementHandler:Label(text)
			...
			LabelText.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
		...
		function ElementHandler:Dropdown(text, list, callback)
			...
			DropItemHolder.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			...
			for i, v in next, list do
				...
				Option.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
				Option.BorderSizePixel = 0
				Option.BorderColor3 = Color3.fromRGB(24, 24, 24)
		...
		function ElementHandler:Colorpicker(text, preset, callback)
			...
			Colorpicker.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			...
			ColorpickerFrame.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			...
			RainbowToggle.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			...
			RainbowStatus.BackgroundColor3 = Color3.fromRGB(74, 74, 74)
